...
ap.add_argument("-i", "--input", type=str, default="recogVideo/"+str(fc.file_name)+".mp4", help="path to input video")
ap.add_argument("-o", "--output", type=str, default="data/data_faces_from_camera/"+str(fc.file_name), help="path to output directory of cropped faces")
...
ap.add_argument("-s", "--skip", type=int, default=4, help="# of frames to skip before applying face detection")
